...
# а в другом  — данные об их хобби. Известно,
# что при хранении данных используется принцип:
...
r_dict = dict()
with open('data/users.csv', 'r', encoding='utf-8') as f1, open('data/hobby.csv', 'r', encoding='utf-8') as f2:
    for line1 in f1:
...
with open('result.json', 'w', encoding='utf-8') as res_file:
    dict_as_string = json.dumps(r_dict, ensure_ascii=False)
    res_file.write(dict_as_string)
